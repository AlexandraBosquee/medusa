...
<div class="container">
    <div class="block__acceuil">
        <h2 data-scroll data-scroll-speed="0.05">Qui est le vrai monstre ?</h2>
    ...
    <div class="block__acceuil">
        <h2 data-scroll data-scroll-speed="0.05">Pourquoi je vous raconte cette histoire ?</h2>
        <div class="connecteur">
            <div class="connecteur__ligne">
                <?php include 'svg/ligne.svg' ?>
            </div>
    ...
    <div class="block__acceuil">
        <h2 data-scroll data-scroll-speed="0.05">Qu’est-ce que la culture du viol ?</h2>
        <div class="connecteur">
            <div class="connecteur__ligne">
                <?php include 'svg/ligne.svg' ?>
            </div>
    ...
    <div class="block__acceuil">
        <h2 data-scroll data-scroll-speed="0.05" >Quel est notre mission ?</h2>
        <div class="connecteur">
            <div class="connecteur__ligne">
                <?php include 'svg/ligne.svg' ?>
            </div>
    ...
    <div class="block__acceuil">
        <h2 data-scroll data-scroll-speed="0.05" >Quel sont ses stéréotype ?</h2>
        <div class="connecteur">
            <div class="connecteur__ligne">
                <?php include 'svg/ligne.svg' ?>
            </div>
